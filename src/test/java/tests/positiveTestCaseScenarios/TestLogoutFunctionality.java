...
public class TestLogoutFunctionality {
    ...
    @Description("Test logout functionality after successful apoointment request!")
    @Test
    public void allOptionsSelected() {
        ...
        WebElement toggleLogout = driver.findElement(By.xpath("//*[@id=\"menu-toggle\"]"));
        toggleLogout.click();

        //click on logout button

        WebElement logoutButton = driver.findElement(By.xpath("//*[@href=\"authenticate.php?logout\"]"));
        logoutButton.click();

        //after logout check for the cura healthcare service homepage

        WebElement message = driver.findElement(By.xpath("//*[@id=\"top\"]/div/h1"));

        String actualHomeMessage = message.getText().trim();
        String expectedHomeMessage = "CURA Healthcare Service";

        Assert.assertEquals(actualHomeMessage, expectedHomeMessage, "Homescreen message failed to populate!");
